<div class="row mb-3">
  <div class="col-lg-6">
    <x-form-text name="name" label="Permission Name" placeholder="product-manager" class="mb-2"/>
  </div>
  <div class="col-lg-6">
    <x-form-text name="label" label="Permission Label" placeholder="Product Manager" class="mb-2"/>
  </div>
  <div class="col-lg-12">
